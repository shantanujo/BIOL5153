...
parser.add_argument("-q","--queue", help='specifies the queue', type=str)
parser.add_argument("-n", "--nodes", help='specifies the number of nodes', type=str)
parser.add_argument("-np","--num_processors", help='specifies the number of prcessors to use', type=str)
